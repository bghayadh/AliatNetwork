<settings>
<client ip="70.80.85.128" lat="45.5934" lon="-73.6418" isp="Videotron Ltee" isprating="3.7" rating="0" ispdlavg="0" ispulavg="0" loggedin="0" country="CA"/>
...
<text id="counterdescription">TOTAL TESTS TO DATE</text>
...
<text id="share-accountdescription">Being logged in would allow you to start a Speed Wave here! Registration is free and only requires a valid email address.</text>
...
<text id="endtest-compare-button">COMPARE YOUR RESULT</text>
<text id="endtest-contribute-button">CONTRIBUTE TO NET INDEX</text>
<text id="close">CLOSE</text>
<text id="survey-retake">RETAKE THE SURVEY</text>
...
<text id="survey-validationUploadline1">Please check your upload speed. This seems faster than expected.</text>
<text id="survey-validationAmountline1">Please check the amount entered. This seems higher than expected.</text>
<text id="survey-validationDownloadline1">Please check your Download speed. This seems faster than expected.</text>
